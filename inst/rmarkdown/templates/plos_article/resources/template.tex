...
\usepackage[top=0.85in,left=1.25in,footskip=0.75in]{geometry} % left=2.75
...
\textwidth 6.75in % \textwidth 5.25in
\textheight 8.75in
...
\fancyheadoffset[L]{0.75in} %2.25
\fancyfootoffset[L]{0.75in} %2.25
\lfoot{\today}
